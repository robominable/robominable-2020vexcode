 ...
 */
 ...
 vex::motor upperIntake = vex::motor(PORT19,vex::gearSetting::ratio18_1,false);
 vex::motor lowerIntake = vex::motor(PORT11,vex::gearSetting::ratio18_1,false);
 vex::motor Lintake = vex::motor(PORT14,vex::gearSetting::ratio18_1,false);
 vex::motor Rintake = vex::motor(PORT18,vex::gearSetting::ratio18_1,false);
 ...
 void usercontrol( void ) {
   ...
   while (1) {
    ...
    if(Controller.ButtonL1.pressing()){ //front intakes in
      Lintake.spin(vex::directionType::fwd,100,vex::velocityUnits::pct);
      Rintake.spin(vex::directionType::fwd,-100,vex::velocityUnits::pct);
    }
    else if(Controller.ButtonL2.pressing()){ //front intakes out
      Lintake.spin(vex::directionType::fwd,-100,vex::velocityUnits::pct);
      Rintake.spin(vex::directionType::fwd,100,vex::velocityUnits::pct);
    }
    else{
    ...
    if(Controller.ButtonR1.pressing()){ //middle intake and out
      lowerIntake.spin(vex::directionType::fwd,100,vex::velocityUnits::pct);
      upperIntake.spin(vex::directionType::fwd,100,vex::velocityUnits::pct);
    }
    else if(Controller.ButtonR2.pressing()){ //middle intake and poop
      lowerIntake.spin(vex::directionType::fwd,100,vex::velocityUnits::pct);
      upperIntake.spin(vex::directionType::fwd,-100,vex::velocityUnits::pct);
    }
    else{
    ...
    if(Controller.ButtonUp.pressing()){ //manual control of lower intake
    ...
    if(Controller.ButtonUp.pressing()){ //manual control of upper intake
